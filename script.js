...
let item_cost = document.querySelectorAll('.merch-item-price');
let item_disc = document.querySelectorAll('.merch-item-descr');
let disc = [
...
let cost = ['1000', '1000', '2500', '5000'];

for (let i = 0; i < item_cost.length; i++) {
    item_cost[i].innerHTML = cost[i];
    item_disc[i].innerHTML = disc[i];
}
